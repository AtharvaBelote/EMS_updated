...
export default function OnboardingWizard() {
          ...
          >
            <CardContent>
              <Box display="flex" alignItems="center" gap={2} mb={2}>
                <Avatar
                  sx={{ backgroundColor: "#4caf50", width: 60, height: 60 }}
                >
              ...
              <Alert severity="success" sx={{ mb: 2 }}>
                🎉 Your company is now ready to start managing employees and
                payroll!
              </Alert>
              <Typography variant="body2" sx={{ color: "#b0b0b0", mb: 2 }}>
                This quick setup will help you get started with the essential
                features:
              </Typography>
              <List>
                <ListItem>
          ...
          >
            <CardContent>
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                💡 You can update your company profile anytime from the Settings
                page
              </Alert>
              <Typography variant="body2" sx={{ color: "#b0b0b0" }}>
                Your company profile is now active. You can customize it further
                by:
              </Typography>
              <List>
                <ListItem>
        ...
        <Box>
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" sx={{ color: "#b0b0b0", mb: 2 }}>
                You can now start adding employees to your team. Here's what you
                can do:
              </Typography>
              <List>
                <ListItem>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: "#b0b0b0" }}>
                  Start with a few test employees to familiarize yourself with
                  the system before adding your entire team.
                </Typography>
              </Box>
            </CardContent>
          </Card>
          ...
          >
            <CardContent>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: "#b0b0b0" }}>
                  Make sure to configure payroll settings before processing your
                  first payroll to avoid errors.
                </Typography>
              </Box>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: "#b0b0b0" }}>
                  ...
                  employee management system. You can access help documentation
                  and contact support from the Settings page.
                </Typography>
              </Box>
            </CardContent>
          </Card>
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: "auto", p: 3 }}>
      <Paper
        sx={{ backgroundColor: "#2d2d2d", border: "1px solid #333", p: 3 }}
      >
        <Typography
          variant="h4"
        ...
        <Stepper
          ...
          sx={{ "& .MuiStepLabel-root": { color: "#ffffff" } }}
        >
